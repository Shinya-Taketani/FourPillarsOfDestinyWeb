...
final class SolarTermCsvReader
{
    ...
    /**
     * @return list<array{year:int,term_name:string,longitude_degree:int,started_at:string,timezone:string,calendar_system:string,source_title:string,source_url:string,source_rank:string,adopted:bool,note:string}>
     */
     ...
     * @return array{year:int,term_name:string,longitude_degree:int,started_at:string,timezone:string,calendar_system:string,source_title:string,source_url:string,source_rank:string,adopted:bool,note:string}
     */
    private function validateRow(array $row, int $lineNumber, int $fromYear, int $toYear): array
    {
        ...
        if ($row['timezone'] !== 'Asia/Tokyo'
            ...
            || $row['source_url'] !== 'https://eco.mtk.nao.ac.jp/cgi-bin/koyomi/cande/phenomena_sy.cgi?year='.$year) {
    ...
    /**
     * @param  list<array{year:int,term_name:string,longitude_degree:int,started_at:string,timezone:string,calendar_system:string,source_title:string,source_url:string,source_rank:string,adopted:bool,note:string}>  $rows
     */
