    ...
    private function calculationMetadata(
        ...
        return [
            ...
            'adopted_solar_term_source' => [
                ...
                'source_rank' => $monthPillar['source_rank'] ?? 'PENDING',
                'adopted' => (bool) ($monthPillar['adopted'] ?? false),
                'verification_status' => $monthPillar['verification_status'] ?? null,
                'precision_level' => $monthPillar['precision_level'] ?? null,
            ],
