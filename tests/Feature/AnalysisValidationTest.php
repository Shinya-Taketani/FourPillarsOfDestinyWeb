...
class AnalysisValidationTest extends TestCase
{
    ...
    public function test_single_analysis_api_accepts_valid_input(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('data.calculation_metadata.adopted_solar_term_source.precision_level', 'minute')
    ...
    public function test_1980_input_uses_the_complete_official_calendar_dataset(): void
    {
        $this->seedCalendarEvents();
        $payload = $this->validPayload();
